...
<body>
	...
	<h1>글 작성</h1>
	<form action="/board/insertbatch" method="post" encType="multipart/form-data" id="form1">
	<table class="table table-bordered" >
	<c:forEach var="i" begin="1" end="5" step="1">
		 <tr><td colspan="2">${i}</td></tr>
	     <tr>
	         <th>제목: </th>
	         <td><input type="text" placeholder="제목을 입력하세요. " name="brd_title[]" class="form-control" value="testtitle"/></td>
	     </tr>
	     <tr>
	         <th>내용: </th>
	         <td><textarea cols="10" placeholder="내용을 입력하세요. " name="brd_content[]" class="form-control"> testcontent </textarea></td>
	     </tr>
   	     <!-- <tr>
	         <th>첨부파일: </th>
